...
const translations = {
    ...
    parentTitle3: { km: 'លោកជំទាវ សំ​ សុផារី', en: 'Her . E. SAM Sophary' },
    ...
    groomName: { km: 'ជិន', en: '' }, 
    groomName1: { km: 'ជិន សុវណ្ណរតនៈ', en: 'Chin Sovannarotanak' },//////
    ...
    ceremonyAncestor: { km: 'ពិធិសូត្រមន្តចម្រើនព្របរិត្ត', en: 'Monk\'s Blessing Ceremony' },
    ...
    ceremonyLunch: { km: 'អញ្ជើញភ្ញៀវពិសារអាហារថ្ងៃត្រង់', en: 'Honored guests to enjoy the lunch banquet.' },
    ...
    if (enterButton) {
        enterButton.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                // Play music with mobile-specific handling
                if (!audioPlayed && bgMusic) {
                    bgMusic.volume = 0.5;
                    
                    // For mobile devices, use user gesture to enable audio playback
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (entranceButton) {
        // Don't mute initially - let user interaction handle autoplay
        updateButtonIcon();
